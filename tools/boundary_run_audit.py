...
for phrase in ["Boundary Run v9", "v9.5.0", "Ari", "Kibo", "RUN GAME", "Replay Proof", "Dogecoin", "DMwHAhqVNWf7dyEznukxCufNS5rjuP5MTp", "Not a medical device", "No telemetry", "Content-Security-Policy"]:
...
print("Audit OK: v9.5.0 security, deterministic hardening, CI/CD and no stale markers")
